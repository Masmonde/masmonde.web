...
document.addEventListener('DOMContentLoaded', function () {
    // ตรวจสอบว่าคุกกี้ projectViewed ถูกตั้งค่าไว้หรือยัง
    if (getCookie('projectViewed')) {
        document.getElementById('viewProjectButton').style.display = 'none' // ซ่อนปุ่มหากคุกกี้ถูกตั้งค่า
    }
})

function setProjectViewed() {
    setCookie('projectViewed', 'true', 365) // เก็บคุกกี้เป็นเวลา 1 ปี
}
